...
_Enter my own appointments from My Page_  
...
_Report training accomplished_  
...
_For sorties, report 781, Fuel, and Weapons used from My Page_  
...
_Qualification Training_ - These are courses in which you are enrolled.
...
_Stan/Eval_ - Displays your Open Evaluations, Failed Evaluations, Periodic Incomplete Requisites, and Non-Periodic Incomplete Requisites. 

_Bids & Availability_ - Designed for part-time personnel \(ANG and AFRC\). This section allows you to enter your availability and to bid on sorties and commitments.
...
_FCIF \(Read File Items\)_ - Displays all your assigned read file items. To sign off an item, click on the indicator, which brings up the Sign Off dialog. Select the item and click the View Link. If there is an attachment, click the link associated with the attached file to view it. After review, click the Sign Off button.

_Folders_ - Displays Training and Stan Eval Folders of personnel you supervise and the personnel they supervise. You can also email them their To-Do list from here.
...
4. Before using data elements from the Aircraft or Aircraft Status list boxes, you must select the ”Tail\#” data element from the Sorties list box. That way, PEX knows which aircraft you want the data for.
...
5. After using the ”\[User Defined\]” label, you must tab/click out of the field before dragging another label/data element.
6. To display crewmember remarks, select all of the desired crew positions \(or 'Entire Crew'\) before selecting 'Crew Remarks.'
>!!! note "Note"
